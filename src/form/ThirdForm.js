      ...
      <Col xs="12" sm="12">
        <Card className="card-border">
          ...
          <div style={{ paddingBottom: 30 }}>
            ...
            <Button id="Popover1" type="button" color="primary" className="btn-pill pull-right" style={{marginRight: '20px'}}>
              Want to submit 
            </Button>
            <Popover placement="left" isOpen={popoverOpen} target="Popover1" toggle={toggle}>
              <PopoverHeader>Submit Details</PopoverHeader>
              <PopoverBody> You cannot change information after successful submission.
                <div className="row">
                  <div className="col">
                  <Button className="btn-pill" onClick = {cancel}>Cancel</Button>  
                  </div>
                  <div className="col">
